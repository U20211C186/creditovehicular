...
@Component({
  ...
  styleUrls: ['./refinanciamiento.component.css']
})
...
quedarseConElAuto():void{
  console.log({
    ...
    diaPago: RefinanciamientoComponent.diaPagoGlobal,
    ...
    cuotaMensual: RefinanciamientoComponent.cuotaMensualGlobal,
    cok: this.tasaDescuento,
    van: RefinanciamientoComponent.vanGlobal,
    tir: RefinanciamientoComponent.tirGlobal,
    ...
    flujoMensual: RefinanciamientoComponent.flujoMensualGlobal,
    tasaSeguroVehicular: this.seguroVehicularAnual,
    seguroVehicular: RefinanciamientoComponent.seguroVehicularGlobal,
    tcea: RefinanciamientoComponent.tceaGlobal
  });
  this.cuotaFinal="0";
...
getCalculosPeriodoGraciaTotalYParial(): void {
  ...
  RefinanciamientoComponent.cuotonGlobal = this.cuotaFinal;

  this.montoPrestamo=(this.cuotaFinal).toString();
  this.periodoPago=(parseInt(this.periodoPago)/2).toString();
  ...
  if(this.periodoPago==='18'){
    gastosAdministracionMensual[19]=0;
    seguroVehiMensual[19]=0;
    portesMensual[19]=0;
...
//4
  ...
  if(parseInt(this.periodoPago)===18){
    interesMensual[19]=0;
  ...
  if (parseInt(this.periodoPago) == 18) {
    ...
    auxcuotaMensual[17] = auxcuotaMensual[1];

    auxcuotaMensual[18] = (parseInt(this.cuotaFinal) * 1);
...
/*
    ...
    //sumaVAN=auxVAN;
    RefinanciamientoComponent.vanGlobal = sumaVAN.toFixed(2);

    

    const auxTIR: number = finance.IRR((parseInt(this.montoPrestamo) * -1), ...auxflujoMensual);
    console.log(`sumaTIR: `, auxTIR);
    RefinanciamientoComponent.tirGlobal = auxTIR.toFixed(2);
...
/*
  ...
  RefinanciamientoComponent.cuotaMensualGlobal = cuotaMensual[5].toFixed(2);

  RefinanciamientoComponent.flujoMensualGlobal = (flujoTotalMensual[5]).toFixed(2);
  ...
  RefinanciamientoComponent.diaPagoGlobal = dia.toString();

  console.log('Fecha Desembolso:', this.fechaDesembolso);
  console.log('Moneda:', this.tipoMoneda);
  console.log('Dia Pago:', RefinanciamientoComponent.diaPagoGlobal);
  ...
  console.log('Cuota Final:', this.cuotaFinal);
  console.log('Cuotas al Año:', this.cuotasAño);
  console.log('Cuota Mensual:', RefinanciamientoComponent.cuotaMensualGlobal);

  console.log('COK:', this.tasaDescuento);
  console.log('VAN:', RefinanciamientoComponent.vanGlobal);
  console.log('TIR:', RefinanciamientoComponent.tirGlobal);
  //=+(1+C206)^12-1
  RefinanciamientoComponent.tceaGlobal = ((((Math.pow(1+(parseFloat(RefinanciamientoComponent.tirGlobal)/100),12))-1)*100).toFixed(2)).toString();

  RefinanciamientoComponent.seguroVehicularGlobal = (seguroVehiMensual[5].toString()); 
